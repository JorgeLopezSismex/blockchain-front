        ...
        <Container fluid>
          ...
          <Row className='py-3 px-5 mx-5'>
            ...
            <div className="wrapper align-left">
              <h1 style={{fontSize:'40px'}}>Emite, Gestiona y Verifica Certificados en Blockchain</h1>
              <p style={{fontSize:'25px'}}>
                La plataforma líder en Ethereum para certificados digitales seguros y verificables. 
                Almacena de manera segura y siempre accesible.
              </p>
            </div>
            </Col>
            <Col xs={12} md={6}>
          ...
          {/* Que es blockchain */}
          <Row className="px-5 py-5" style={{backgroundColor:'#F8F9FA', textAlign:'center'}}>
            <Col>
              <div className='px-5 mx-5'>
                <h2 className='mb-4'>¿Qué es Blockchain?</h2>
                <p style={{fontSize:'18px'}}>
                  Bloackchain es una innovadora plataforma que te permite crear y validar certificados de manera segura en la blockchain de Ethereum. Con Blockchain, tus   logros académicos y profesionales son inmutables y accesibles en cualquier momento y lugar. Nuestra tecnología de vanguardia garantiza la autenticidad y la   integridad de tus certificados.
                  ¡Comienza a usar Blockchain hoy mismo!
                </p>
              </div>

              <Button variant="secondary" className='my-3'>Empezar</Button>
            </Col>
          </Row>
          ...
          <Row className='py-3 px-3 mb-3 mt-5'>
            ...
            <Col sm={12} md={6} className='px-5 align-items-center' style={{display:'flex'}}>
              <div>
                ...
                <a href="https://www.apple.com/mx/app-store/" target="_blank" rel="noopener noreferrer">
                  <img
                ...
                <a href="https://play.google.com/store/apps?hl=es_MX&gl=US" target="_blank" rel="noopener noreferrer" className="ml-3">
                <img
        ...
        <Container>
         ...
         <Accordion defaultActiveKey={['0']} alwaysOpen>
          <Accordion.Item eventKey="0">
            <Accordion.Header>¿Qué es la tecnología blockchain y cómo la utilizan en su plataforma?</Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header>¿Cómo puedo emitir un certificado en su plataforma?</Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header>¿Cómo verifico la autenticidad de un certificado?</Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="3">
            <Accordion.Header>¿Cuáles son los beneficios de su plataforma para las instituciones educativas?</Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="5">
            <Accordion.Header>¿Cómo puedo registrarme en su plataforma?</Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="5">
            <Accordion.Header>¿Qué sucede si pierdo mi acceso a la plataforma?</Accordion.Header>
            <Accordion.Body>
